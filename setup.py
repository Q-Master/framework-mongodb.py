...
"""Install script for framework-mongodb.py"""
...
NAME = 'asyncframework-mongodb'
PACKAGES = find_packages(exclude=['tests'])
DESCRIPTION = 'Async framework mongodb addon.'
URL = 'https://github.com/Q-Master/framework-mongodb.py'
...
LONG_DESCRIPTION = """***asyncframework-mongodb*** - async framework mongodb addon
===
